...
(function (global) {
  ...
  const SYSTEM = [
    ...
    "",
    "How to choose well:",
    "- Always open with exactly one short `render_text` — a single conversational sentence, in",
    "  the buyer's language — before any other component. Then let components carry the content.",
